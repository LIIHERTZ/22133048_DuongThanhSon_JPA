...
import JPA.services.impl.VideoService;
import JPA.services.ICategoryService;
import JPA.services.impl.CategoryService;
...
public class VideoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (url.contains("insert")) {
            ...
            String poster = "";
            String uploadPath = "D:\\Tool_LapTrinhWeb\\SpringTool\\upload";
...
//					category.setImages(fname);
                    ...
                    poster = "D:\\Tool_LapTrinhWeb\\SpringTool\\upload"; // Default poster if none is uploaded
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
